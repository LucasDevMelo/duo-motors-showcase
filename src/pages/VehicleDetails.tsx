...
const BackgroundPattern = () => (
  // ALTERAÇÃO AQUI: Mudado de 'fixed' para 'absolute'
...
const VehicleDetails = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col relative font-sans text-slate-800">
      {/* Background Posicionado Absolutamente (Rola com a tela) */}
      <BackgroundPattern />
                  ...
                  <div className="flex gap-3 overflow-x-auto pb-4 scrollbar-hide px-1">
                    {images.map((image, index) => (
                      <button
                        ...
                        className={`flex-shrink-0 w-28 h-20 rounded-lg overflow-hidden transition-all shadow-sm ${
                          currentImage === index 
              ...
              <div className="flex flex-col justify-center lg:pl-4">
                <div>
                  ...
                  <div className="flex flex-wrap gap-3 mb-8">
                    <span className="bg-slate-200/50 text-slate-800 px-4 py-2 rounded-lg font-medium border border-slate-300/50">
                      {vehicle.year}
                    </span>
                    <span className="bg-slate-200/50 text-slate-800 px-4 py-2 rounded-lg font-medium border border-slate-300/50">
                  ...
                  <div className="mb-10">
                    <p className="text-sm text-slate-500 mb-1 font-medium uppercase tracking-wide">Preço à vista</p>
                    <p className="text-5xl font-bold text-slate-900 tracking-tight">
                      <span className="text-2xl font-normal text-slate-500 mr-2">R$</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
              ...
              <div className="lg:col-span-5">
                <div className="sticky top-24">
                  <h2 className="text-2xl font-bold text-slate-900 mb-8 pb-4 border-b border-slate-300/50">
                    Ficha Técnica
                  </h2>
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center py-2 bg-slate-200/30 px-3 rounded-lg">
                    ...
                    {specs && Object.keys(specs).length > 0 && (
                      <>
                        <h3 className="text-lg font-bold mt-8 mb-4 text-slate-900 pt-4 border-t border-slate-300/50">Opcionais</h3>
                        {Object.entries(specs).map(([key, value], idx) => (
                          <div key={key} className={`flex justify-between items-center py-2 ${idx % 2 === 0 ? 'bg-slate-200/30 px-3 rounded-lg' : ''}`}>
