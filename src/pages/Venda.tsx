...
const useLocation = () => ({ pathname: '/venda' }); 
      ...
      <header className="fixed top-0 left-0 right-0 bg-white z-50 border-b">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:block">
            {/* Botão refatorado para ser um link estilizado diretamente */}
            <a 
          ...
          <div className="md:hidden">
            {/* Botão do menu agora é um <button> padrão estilizado */}
            <button 
        ...
        <div className="fixed inset-0 top-16 bg-white z-40 md:hidden">
          <nav className="flex flex-col items-center justify-center h-full gap-8 text-xl">
            {navLinks.map((link) => (
             ...
             {/* Botão do menu mobile refatorado */}
            <a 
              href="https://wa.me/556196081413" 
              target="_blank" 
              rel="noopener noreferrer" 
...
// --- Componente Principal da Página Venda ---
